...
//
#ifndef PXR_IMAGING_PLUGIN_HD_KRAKEN_RENDER_PARAM_H
#define PXR_IMAGING_PLUGIN_HD_KRAKEN_RENDER_PARAM_H
...
class HdKrakenRenderer;

///
/// \class HdKRakenRenderParam
///
...
/// embree state around.
/// 
class HdKrakenRenderParam final : public HdRenderParam
{
public:
    HdKrakenRenderParam(//RTCDevice device, RTCScene scene,
    ...
    //HdKrakenRenderer* GetRenderer() { return _renderer; }
...
#endif // PXR_IMAGING_PLUGIN_HD_KRAKEN_RENDER_PARAM_H

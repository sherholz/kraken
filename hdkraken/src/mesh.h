...
//
#ifndef EXTRAS_IMAGING_EXAMPLES_HD_KRAKEN_MESH_H
#define EXTRAS_IMAGING_EXAMPLES_HD_KRAKEN_MESH_H
...
///
class HdKrakenMesh final : public HdMesh 
{
public:
    HF_MALLOC_TAG_NEW("new HdKrakenMesh");

    /// HdKrakenMesh constructor.
    ///   \param id The scene-graph path to this mesh.
    HdKrakenMesh(SdfPath const& id);

    /// HdKrakenMesh destructor.
    ~HdKrakenMesh() override = default;
...
protected:
    ...
    HdKrakenMesh(const HdKrakenMesh&) = delete;
    HdKrakenMesh &operator =(const HdKrakenMesh&) = delete;
};

PXR_NAMESPACE_CLOSE_SCOPE

#endif // EXTRAS_IMAGING_EXAMPLES_HD_KRAKEN_MESH_H

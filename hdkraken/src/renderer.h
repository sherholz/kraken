...
//
#ifndef PXR_IMAGING_PLUGIN_HD_KRAKEN_RENDERER_H
#define PXR_IMAGING_PLUGIN_HD_KRAKEN_RENDERER_H
...
///
/// HdKrakenRenderer implements a renderer on top of Embree's raycasting
...
#endif // PXR_IMAGING_PLUGIN_HD_KRAKEN_RENDERER_H

...
//
#ifndef PXR_IMAGING_PLUGIN_HD_KRAKEN_RENDER_BUFFER_H
#define PXR_IMAGING_PLUGIN_HD_KRAKEN_RENDER_BUFFER_H
...
class HdKrakenRenderBuffer : public HdRenderBuffer
{
public:
    HdKrakenRenderBuffer(SdfPath const& id);
    ~HdKrakenRenderBuffer() override;
...
#endif // PXR_IMAGING_PLUGIN_HD_KRAKEN_RENDER_BUFFER_H
